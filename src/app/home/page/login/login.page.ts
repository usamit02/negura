...
export class LoginPage implements OnInit, OnDestroy {
  email = new FormControl("touringstay@gmail.com", [Validators.email, Validators.required]);
  password = new FormControl("touring", [Validators.required]);
  ...
  constructor(private fireAuth: AngularFireAuth, private ui: UiService, private user: UserService,
    private router: Router, private builder: FormBuilder, private location: Location, private alert: AlertController,) {
